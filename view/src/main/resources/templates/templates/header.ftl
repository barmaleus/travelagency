        ...
        <nav>
            ...
            <div class="uui-responsive-header">
                <div class="responsive-header">
                    <#if security.hasRole('ROLE_ADMIN') && security.isAuthenticated()>
...
<#--                    </@security.authorize>-->
                    <a href="/" class="responsive-brand-logo">
                        ...
                        <span class="title">${springMessage("header.name")}</span>
                ...
                <div class="responsive-menu">
                    <div class="menu-wrapper">
                        <div class="menu-scroll">
                            ...
                            <#if security.hasRole('ROLE_ADMIN') && security.isAuthenticated()>
                                <li class="sub-menu">
                                    <a href="#"><span>${springMessage("header.manage")}</span></a>
                                    <ul class="sub">
                                        <li><a href="/tours" onclick="return false;">${springMessage("c.tours")}</a></li>
                                        <li><a href="/users" onclick="return false;">${springMessage("c.users")}</a></li>
                                        <li><a href="/hotels" onclick="return false;">${springMessage("c.hotels")}</a></li>
                                        <li><a href="/reviews" onclick="return false;">${springMessage("c.reviews")}</a></li>
                                        <li><a href="/countries" onclick="return false;">${springMessage("c.countries")}</a></li>
                                    </ul>
                                <li>
                                    <a href="import"><span>${springMessage("header.import")}</span></a>
                                </li>
                            </#if>
                                <li class="sub-menu profile-menu">
                                    <a href="#"><span>${springMessage("header.profile")}</span></a>
                                    <ul class="sub">
                                        <#if security.isAuthenticated()>
                                            <li class="profile"><a href="/profile"><span>${springMessage("header.profile")}</span></a></li>
                                            <li class="logout"><a href="/sign-out"><span>${springMessage("header.signout")}</span></a></li>
                                        </#if>
                                        <#if ! security.isAuthenticated()>
                                            <li class="sign-up"><a href="/sign-up"><span>${springMessage("header.signup")}</span></a></li>
                                            <li class="login"><a href="/sign-in"><span>${springMessage("header.signin")}</span></a></li>
                                        </#if>
                                    </ul>
                                </li>
                            </ul>
