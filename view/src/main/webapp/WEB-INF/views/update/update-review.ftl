                    ...
                    <div class="login-panel-section">
                        ...
                        <form role="form" action="/update-review" method="post">
                            ...
                            <div>
                                ...
                                <textarea id="text" onkeyup="scriptProtectionText(this)" class="uui-form-element" rows="3" cols="10" name="text" pattern=".{20,}" required title="20 characters minimum">${review.text}</textarea>
                            </div>
                            <br>
