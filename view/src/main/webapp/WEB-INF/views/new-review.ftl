                    ...
                    <div class="login-panel-section">
                        ...
                        <form role="form" action="/reg-review" method="post">
                            <div>
                                ...
                                <select name="user" class="selectpicker uui-form-element large" data-live-search="true" title="Choose one of the following users">
                                    <#list users as user>
                            ...
                            <div>
                                ...
                                <select name="tour" class="selectpicker uui-form-element large" data-live-search="true" title="Choose one of the following tours">
                                    <#list tours as tour>
                                        <option value="${tour.id}">${tour.country.name} ${tour.date}</option>
                                    </#list>
                                </select>
                            </div>
                            <div>
