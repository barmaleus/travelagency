package by.rekuts.travelagency.domain.config;
...
@ComponentScan(basePackages = "by.rekuts.travelagency.domain")
...
public class JpaConf {
    ...
    public DataSource getDataSource() {
        ...
        config.setJdbcUrl("jdbc:postgresql://localhost:5432/travelagency");
